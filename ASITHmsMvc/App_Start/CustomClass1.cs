...
/// <summary>
/// Summary description for CustomClass1
/// </summary>
namespace ASITHmsMvc
{
    public class CustomClass1
    {
        ...
        public static List<AttnClass1> HcmGeneralClass1()
        {
            var attn1 = new List<AttnClass1>();
            for (int i = 0; i < 31; i++)
            {
                var dt1 = DateTime.Today.AddDays(i);
                attn1.Add(new AttnClass1() { AttnDate = dt1, AttnDesc = @"Description -" + i });
            }
            return attn1;
        }

        public class AttnClass1
        {
            public DateTime AttnDate { get; set; }
            public string AttnDesc { get; set; }
    ...
    public static class HcmGeneralClass1
    {
        ...
        public static List<HmsEntityManpower.RptAttnSchInfo> GetIndRosterAttendance(string monthid1, string hccode1a, string RptType = "Attendance")
        {
            ...
            if (RptType == "Attendance")
            {
                ...
                string hcDept1 = "";
                var pap1 = vm2.SetParamShowActualAttnInfo1(AspSession.Current.CompInfList[0].comcpcod, monthid1, AttnDate1, AttnDate1, hccode1a, hcDept1);
